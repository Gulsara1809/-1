...
public class SearchPageObject extends MainPageObject
{
        ...
        {
                this.waitForElementAndClick(By.id (SEARCH_CANCEL_BUTTON), "Cannot find and click", 5 );
        }
        ...
        {
                String search_result_xpath = getResultSearchElement(substring);
                this.waitForElementAndClick(By.xpath(search_result_xpath), "Cannot find search result and click" + substring, 10);
        }
